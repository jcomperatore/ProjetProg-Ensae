...
class Test_Reachability(unittest.TestCase):
    def test_network0(self):
        g = graph_from_file("/Users/julescomperatore/ProjetProg-Ensae/delivery_network/input/network.00.in")
        self.assertEqual(g.get_path_with_power(1, 4, 11), [1, 2, 3, 4])
        self.assertEqual(g.get_path_with_power(1, 4, 10), None)

    def test_network2(self):
        g = graph_from_file("/Users/julescomperatore/ProjetProg-Ensae/delivery_network/input/network.02.in")
